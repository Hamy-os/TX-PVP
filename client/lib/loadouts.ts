...
export class Loadouts {
  public static loadOuts: Loadout = {
    DEA: {
      "basic": [{ name: "weapon_militaryrifle", ammoCount: 9999, addons: [] },
      ...
      "sniper": [{ name: "weapon_heavysniper_mk2", ammoCount: 9999, addons: ["COMPONENT_AT_SCOPE_NV", "COMPONENT_AT_SR_SUPP_03", "COMPONENT_AT_SR_BARREL_02", "COMPONENT_HEAVYSNIPER_MK2_CAMO_03"] },
      { name: "weapon_pistol_mk2", ammoCount: 9999, addons: ["COMPONENT_PISTOL_MK2_CLIP_02", "COMPONENT_AT_PI_SUPP_02", "COMPONENT_PISTOL_MK2_CAMO_03", "COMPONENT_AT_PI_FLSH_02"] }, {name: "weapon_knife", ammoCount: 9999, addons: []}]
    },
  ...
  public static giveLoadoutToPlayer(loadout: string, side: Team): void {
    ...
    Loadouts.loadOuts[side][loadout].forEach((weapon: LoadoutWeapon) => {
